...
var top_left : PerspectivePoint = PerspectivePoint.new()
var top_right : PerspectivePoint = PerspectivePoint.new()
var bottom_left : PerspectivePoint = PerspectivePoint.new()
var bottom_right : PerspectivePoint = PerspectivePoint.new()
...
func _ready():
	...
	bubble.add_child(top_left)
	bubble.add_child(top_right)
	bubble.add_child(bottom_left)
	bubble.add_child(bottom_right)
	
	top_left.bubble = bubble
	top_right.bubble = bubble
	bottom_left.bubble = bubble
	bottom_right.bubble = bubble
...
func reset() -> void:
	...
	top_right.position = Vector2(bubble.size.x, 0) - half_size
	bottom_left.position = Vector2(0, bubble.size.y) - half_size
	bottom_right.position = bubble.size - half_size
