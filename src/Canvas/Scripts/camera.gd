...
func zoom_in():
	var new_zoom = zoom + Vector2(Preference.general.camera.zoom_rate, Preference.general.camera.zoom_rate)
	if new_zoom.x <= Preference.general.camera.max_zoom and new_zoom.y <= Preference.general.camera.max_zoom:
		zoom = new_zoom

func zoom_out():
	var new_zoom = zoom - Vector2(Preference.general.camera.zoom_rate, Preference.general.camera.zoom_rate)
	if new_zoom.x >= Preference.general.camera.min_zoom and new_zoom.y >= Preference.general.camera.min_zoom:
		zoom = new_zoom
